...
const MODE_LABEL_KEYS: Record<string, string> = {
  ...
  'inout-calendar': 'sidebar.inoutCalendar',
  inbound: 'sidebar.inbound',
  outbound: 'sidebar.outbound',
  'sales-order': 'sidebar.salesOrder',
  bom: 'sidebar.bom',
  'stock-check': 'sidebar.stockCheck',
  partner: 'sidebar.partner',
  'partner-detail': 'sidebar.partner',
  'partner-form': 'sidebar.partner',
  'partner-dashboard': 'sidebar.partnerDashboard',
  driver: 'sidebar.driver',
  'production-board': 'sidebar.productionBoard',
  'production-plan': 'sidebar.productionPlan',
  'work-orders': 'sidebar.workOrders',
  'production-entry': 'sidebar.productionEntry',
